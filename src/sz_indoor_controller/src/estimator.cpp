...
#include "sz_indoor_controller/custom/myobserver.h"
#include <deque>
...
void feedbackCallback(const geometry_msgs::PoseStamped::ConstPtr& feedback_msg, ros::Publisher& state_pub, int& frame_counter, double framerate) {
    ...
    // 发布新状态
    sz_indoor_controller::UAVState state_msg;
...
int main(int argc, char** argv) {
    ...
    // 发布器和订阅器
    ros::Publisher state_pub = nh.advertise<sz_indoor_controller::UAVState>("/uav/state", 10);
