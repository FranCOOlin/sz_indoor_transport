...
void controllCallback(const sz_indoor_controller::UAVState::ConstPtr& state_msg) {
            // 解析输入状态
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "sz_indoor_controllerler");
    ros::NodeHandle nh;
    std::string uav_id;
    ...
    state_sub = nh.subscribe<sz_indoor_controller::UAVState>("/uav/state", 10,controllCallback);
