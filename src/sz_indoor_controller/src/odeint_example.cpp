#include <ros/ros.h>
#include <sz_indoor_controller/Float64MultiArrayWithHeader.h>  // 引入新定义的消息类型
#include <vector>
...
int main(int argc, char** argv) {
    ...
    // 创建一个话题发布者，发布类型为sz_indoor_controller::Float64MultiArrayWithHeader
    pub = nh.advertise<sz_indoor_controller::Float64MultiArrayWithHeader>("integral_topic", 10);
    ...
    while (ros::ok()) {
        ...
        // 创建消息并将积分后的结果存入msg
        sz_indoor_controller::Float64MultiArrayWithHeader msg;
